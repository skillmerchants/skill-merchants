      ...
      <div className='container mx-auto max-w-4xl'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='mt-4 max-w-2xl mx-auto text-lg text-gray-600 leading-relaxed'>
            Connect with {mentor.name} for personalized guidance in{" "}
            {mentor.course}. Book a one-on-one appointment to gain expert
          ...
          <div className='sec4 rounded-xl shadow-lg p-6'>
            ...
            <div className='space-y-4'>
              ...
              <p className='text-gray-600'>
                ...
                <span
                  className={
                    mentor.availability ? "text-green-600" : "text-red-600"
                  }>

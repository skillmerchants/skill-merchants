        ...
        <div className='sec4 rounded-xl shadow-lg p-6 sm:p-8'>
          ...
          <section className='mb-12'>
            ...
            <p className='text-gray-600'>
              Below is a summary of our current service rates and payment
              policies across different features of the platform.
            </p>
          </section>
          ...
          <section className='mb-12'>
            ...
            <p className='text-gray-600 mt-4'>
              Due to limited availability, slots will be granted to early
            ...
            <div className='space-y-4'>
              <div>
                ...
                <ul className='list-disc list-inside text-gray-600 ml-4'>
                  <li>
                    Mentees pay weekly, directly into the official Skill
                    Merchants account.
                  </li>
                  <li>
                    Mentors receive 80%, and Skill Merchants retain 20% as a
                    service fee.
                  </li>
                  <li>
                    Payments to mentors are made only after full payment is
                    received from the mentee.
                  </li>
                </ul>
              </div>
          ...
          <section className='mb-12'>
            ...
            <p className='text-gray-600 mb-4'>
              Scholarships, jobs, internships, and volunteer opportunities are
          ...
          <section>
            ...
            <p className='text-gray-600 mt-4'>
              Please confirm all payments with our support team to ensure
              accurate documentation and activation of services. Contact us via{" "}
              <Link
                href='https://wa.me/2348105669301'
                target='_blank'
                rel='noopener noreferrer'

          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  You must be at least 16 years old to use our services. However, any individual below
                  16 can use our service only under supervision by an adult. By using our service, you
                  confirm that you meet this requirement.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-gray-900">3. Use of the Service</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">4. User Accounts</h3>
                <p className="text-gray-600">
                  To access our service, you are required to submit necessary credentials or
                  information to create your account or card.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-gray-900">5. Payments and Renewals</h3>
                <p className="text-gray-600">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  or licensed to Skill Merchants. You may not reproduce, distribute, or create
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We reserve the right to update these Terms at any time. We will notify users by
                  updating the "Effective Date."
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-gray-900">10. Contact Us</h3>
                <p className="text-gray-600">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 ml-4">
                  <li>Personal Information: name, email, mobile number, etc.</li>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We use cookies to enhance user experience. You can control cookies through your
                  browser settings.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We use industry-standard security measures to protect your data, but we cannot
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We do not knowingly collect data from children under 16. If we learn we have, we
                  will delete it.
                </p>
              </div>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">9. Contact Us</h3>
                <p className="text-gray-600">

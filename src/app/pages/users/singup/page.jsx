            ...
            {password && (
              <div className='mt-2'>
                ...
                <ul className='mt-2 text-sm text-gray-600 space-y-1'>
                  ...
                  <li
                    className={
                      passwordStrength.lowercase ? "text-green-600" : ""
                    }>
                    {passwordStrength.lowercase ? "✓" : "✗"} At least one
                    lowercase letter
                  </li>
                  <li
                  ...
                  <li
                    className={
                      passwordStrength.special ? "text-green-600" : ""
                    }>
                    {passwordStrength.special ? "✓" : "✗"} At least one special
                    character
                  </li>
                </ul>
              </div>

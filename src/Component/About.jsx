...
const About = () => {
    return (
        <div className='flex flex-wrap justify-center items-center gap-5 p-10 bg-white text-black'>   
            <div className='max-w-[350px] flex bg-fuchsia-200 flex-col border-l-1 border-b-1 text-left border-black p-5 m-5'>
